...
public class ReportsGeneratorHandlerDto {
    ...
    public ReportsGeneratorHandlerDto(InputStream inputStream) throws IOException {
        super();
        ...
        this.primaryOrganizationId = readValueFromJsonNode(rootNode, "primaryOrganizationId", String.class);
