...
public class LambdaFunctionHandler implements RequestStreamHandler
{
	...
	public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context) throws IOException {
		...
		try {
			...
			String[] environments = new String[]{"ReliqUsDev1"};//objectMapper.readValue(rootNode.get("environments").toString(), String[].class);
			String[] reportsToBeGenerated = new String[]{"IndividualRPMReadingsReport"};/*objectMapper.readValue(
